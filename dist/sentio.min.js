...
!function(t,e){"object"==typeof exports&&"undefined"!=typeof module?e(exports,require("d3-dispatch"),require("d3-interpolate"),require("d3-scale"),require("d3-shape"),require("d3-axis"),require("d3-brush"),require("d3-voronoi"),require("d3-selection")):"function"==typeof define&&define.amd?define(["exports","d3-dispatch","d3-interpolate","d3-scale","d3-shape","d3-axis","d3-brush","d3-voronoi","d3-selection"],e):e(t.sentio={},t.d3,t.d3,t.d3,t.d3,t.d3,t.d3,t.d3,t.d3)}(this,function(t,e,n,r,i,a,u,l,o){"use strict";function c(){
// Chart create/init method
function t(t){}function a(){var t=d.markSize+d.markMargin;
...
var i=h.key(t,e);n.classed("active",function(t,e){return h.key(t,e)==i}),r.classed("active",function(t,e){return h.key(t.data,e)==i})}else n.classed("active",!1),r.classed("active",!1)},mouseover:function(t,e){t=h.getEventElement(t,e),h.updateActiveElement(t,e),f.call("mouseover",this,t,e)},mouseout:function(t,e){t=h.getEventElement(t,e),h.updateActiveElement(),f.call("mouseout",this,t,e)},click:function(t,e){t=h.getEventElement(t,e),f.call("click",this,t,e)},key:function(t){return t.key},value:function(t){return t.value},label:function(t){return t.key+" ("+t.value+")"}},p={color:r.scaleOrdinal(r.schemeCategory10)},m={arc:i.arc().padAngle(.01),pie:i.pie().value(function(t,e){return h.value(t,e)}).sort(null)},v={div:void 0,svg:void 0,gChart:void 0,legend:void 0},x=[];/*
...
return u=Math.min(n,e)/2,v.svg.attr("width",l).attr("height",o),v.gChart.attr("transform","translate("+(c.left+u)+","+(c.top+u)+")"),m.arc.innerRadius(u*s).outerRadius(u),v.gLegend.attr("transform",a()),t},t.redraw=function(){/**
	 * Private functions
	 */
return function(){/*
		 * Join the data
...
return e[0]>e[1]&&(e[1]=e[0]),e},u(t),u}function g(t){function e(t){r=t}/*
	 * Constructor/initialization method
	 */
function n(t){null!=t&&(null!=t.extent&&e(t.extent),null!=t.series&&function(t){i=t}(t.series))}var r=s(),i=[];/**
	 * Public API
	 */
/*
...
/*
	 ...
	 */
// Initialize the model
return n.extent=function(t){return arguments.length?(e(t),n):r},n.series=function(t){return arguments.length?(i=t,n):i},n.getExtent=function(t){var e;
...
null==e?e=i:(e[0]=Math.min(e[0],i[0]),e[1]=Math.max(e[1],i[1]))}),null==e&&(e=r.getExtent([])),e},n(t),n}function d(t){/**
	 * Private Functions
	 */
function n(t){
...
function r(t){return null!=t&&Array.isArray(t)&&(t=t.map(function(t){return+t})),t}/**
	 ...
	 * @returns {Function}
	 */
function i(t){return function(e){var n=null!=o.event.selection?r(o.event.selection.map(s.invert)):void 0,i=d,a=!((n===i||null!=n&&null!=i&&n[0]===i[0]&&n[1]===i[1])&&h);
...
a&&g.apply(t,this,e)}}function a(t,e){var n=null==(e=/**
...
h=!0,n?c.move(t,void 0):c.move(t,e.map(s))}function l(t){if(null==t)throw new Error("Must provide a brush and a scale");if(null==t.brush)throw new Error("Must provide a brush");if((c=t.brush).on("brush",i("brush")).on("start",i("start")).on("end",i("end")),null==t.scale)throw new Error("Must provide a scale");s=t.scale,null!=t.enabled&&n(t.enabled)}/**
	 * Private variables
	 */
// The brush object
...
var i=_.g.brush.selectAll(".handle-grip").data([{type:"w"},{type:"e"}]),a=i.enter().append("g").attr("class","handle-grip").attr("cursor","ew-resize");a.append("path").attr("d","M0 "+r+" v"+-r),a.append("path").attr("d",h),a.merge(i).attr("transform",function(t,e){return"translate("+n[e]+", 0)"})}else
// Empty the clip path
_.plotBrushClipPath.attr("transform","translate(-1, -1)").attr("width",0).attr("height",0),
// Remove the handles
_.g.brush.selectAll(".handle-grip").remove()}
// Chart create/init method
function v(){}var x="timeline_line_"+Date.now(),y={top:10,right:10,bottom:20,left:40},b=100,k=600,w={xGrid:!1,yGrid:!1,pointEvents:!1},z={valueX:function(t){return t[0]},markerValueX:function(t){return t[0]},markerLabel:function(t){return t[1]},pointRadius:function(){return 2}},A=Date.now(),E={x:s({defaultValue:[A-3e5,A],getValue:function(t,e){return z.valueX(t,e)}}),y:s()},V=g(),M={x:r.scaleTime(),y:r.scaleLinear()},S={x:a.axisBottom().scale(M.x),y:a.axisLeft().ticks(3).scale(M.y),xGrid:a.axisBottom().tickFormat("").tickSizeOuter(0).scale(M.x),yGrid:a.axisLeft().tickFormat("").tickSizeOuter(0).ticks(3).scale(M.y)},B=i.line().x(function(t,e){return M.x(z.valueX(t,e))}),T=i.area().x(function(t,e){return M.x(z.valueX(t,e))}),C=l.voronoi().x(function(t,e){return M.x(t.x,e)}).y(function(t,e){return M.y(t.y,e)}),G=d({brush:u.brushX(),scale:M.x});G.dispatch().on("end",function(){m(),N.call("brushEnd",this,f())}).on("start",function(){m(),N.call("brushStart",this,f())}).on("brush",function(){m(),N.call("brush",this,f())});
...
// Join
var t=_.g.plots.selectAll(".plot").data(L,function(t){return t.key}),e=t.enter().append("g").attr("class","plot"),r=e.append("g").append("path").attr("class",function(t){return(t.category?t.category:"")+" line"}),i=e.append("g").append("path").attr("class",function(t){return(t.category?t.category:"")+" area"}),a=t.select(".line"),u=t.select(".area");if(
// Enter + Update
r.merge(a).attr("d",function(t){return B.y(function(e,n){return M.y(t.getValue(e,n))})(P)}),i.merge(u).attr("d",function(t){return T.y0(M.y.range()[0]).y1(function(e,n){return M.y(t.getValue(e,n))})(P)}),
...
// Join
var t=_.g.plotBrushes.selectAll(".plot-brush").data(G.enabled()?L:[],function(t){return t.key}),e=t.enter().append("g").attr("class","plot plot-brush"),n=e.append("g").append("path").attr("class",function(t){return(t.category?t.category:"")+" line"}),r=e.append("g").append("path").attr("class",function(t){return(t.category?t.category:"")+" area"}),i=t.select(".line"),a=t.select(".area");
// Enter + Update
n.merge(i).attr("d",function(t){return B.y(function(e,n){return M.y(t.getValue(e,n))})(P)}),r.merge(a).attr("d",function(t){return T.y0(M.y.range()[0]).y1(function(e,n){return M.y(t.getValue(e,n))})(P)}),t.exit().remove()}(),function(){
// Join
...
// Enter + Update
var i=t.select("line"),a=t.select("text");n.merge(i).attr("x1",function(t,e){return M.x(z.markerValueX(t,e))}).attr("x2",function(t,e){return M.x(z.markerValueX(t))}),r.merge(a).attr("x",function(t,e){return M.x(z.markerValueX(t))}),
// Exit
...
var r=e[1]-e[0],i=r;null!=c&&(i=Math.min(r,c)),null!=o&&(i=Math.max(i,o)),
// If the width has to change
i!=r&&(e[0]===n[0]?
// We should move the upper bound
e[1]=e[0]+i:e[1]===n[1]&&(
// We should move the lower bound
e[0]=e[1]-i))}return e}(t),function(t){return null!=t&&(null==c||t[1]-t[0]<=c)}(t)){var e=null==n||n[0]!=t[0]||n[1]!=t[1];
// Update the brush
n=t,h.setBrush(n),
...
function(){var t=/**
	 ...
	 */
function(t){var e={pan:!1,zoom:!1};if(null!=t){var n=d.xScale(),r=n.domain()[0],i=t[0],u=t[1],o=n.domain()[1],c=o-r,s=(u-i)/c,g=(i-r)/c<=a.edgeTrigger&&i>l[0],f=(o-u)/c<=a.edgeTrigger&&u<l[1];
// Should we resize and/or recenter?
e.zoom=s>=a.zoomOutTrigger||s<=a.zoomInTrigger,e.pan=g||f}return e}(n);if(t.pan||t.zoom){
...
var e=/**
	 ...
	 * @returns {[*,*]}
	 */
function(t,e){var n=d.xScale().domain()[0],r=t[0],i=t[1],o=d.xScale().domain()[1]-n;
...
o=Math.max((i-r)/a.zoomTarget,u));
// Determine the current center of the brush
var c=r+(i-r)/2,s=Math.max(c-o/2,l[0]);
...
h.setBrush(n)}var n,r="autobrush_timeline_"+Date.now(),i=Date.now(),a={edgeTrigger:.01,zoomInTrigger:.05,zoomOutTrigger:.8,zoomTarget:.2},u=864e5,l=[i-31536e7,i],o=36e5,c=void 0,s=[i-15552e6,i],g=e.dispatch("extentChange","brushChange"),d=f();
...
/**
	 ...
	 */
// Initialize the model
return a.set=function(t){return i(),n(),r(t),a},a.clear=function(){return i(),n(),a},a.add=function(t){return r(t),a},a.lwm=function(t){if(!arguments.length)return u.lwm;var r=u.lwm;
// the difference between watermarks is not a multiple of the bin size, so we need to reset
return u.lwm=Number(t),e(),(r-u.lwm)%u.size!=0&&i(),n(),a},a.hwm=function(){return u.hwm},a.getKey=function(t){return arguments.length?(l.getKey=t,i(),n(),a):l.getKey},a.getValue=function(t){return arguments.length?(l.getValue=t,i(),n(),a):l.getValue},a.updateBin=function(t){return arguments.length?(l.updateBin=t,i(),n(),a):l.updateBin},a.createSeed=function(t){return arguments.length?(l.createSeed=t,i(),n(),a):l.createSeed},a.countBin=function(t){return arguments.length?(l.countBin=t,i(),n(),a):l.countBin},a.afterAdd=function(t){return arguments.length?(l.afterAdd=t,a):l.afterAdd},a.afterUpdate=function(t){return arguments.length?(l.afterUpdate=t,a):l.afterUpdate},a.size=function(t){if(!arguments.length)return u.size;if((t=Number(t))<1)throw new Error("Bin size must be a positive integer");
// Only change stuff if the size actually changes
return t!==u.size&&(u.size=t,e(),i(),n()),a},a.count=function(t){if(!arguments.length)return u.count;if((t=Number(t))<1)throw new Error("Bin count must be a positive integer");
// Only change stuff if the count actually changes
return t!==u.count&&(u.count=Math.floor(t),e(),n()),a},a.bins=function(){return o},a.itemCount=function(){return c},a.clearBin=function(t){if(t>=0&&t<o.length){var e=l.countBin(o[t]);return c-=e,o[t][1]=l.createSeed(),e}return 0},a(t),a}/*
...
var t=Date.now()+2*a.size();
// Trunc the hwm down to a round value based on the binSize
return(t=Math.floor(t/a.size())*a.size())-a.size()*a.count()}function n(){!0===u&&(
// need to update the lwm
a.lwm(e()),window.setTimeout(n,a.size()))}function r(){u||(
// Start the update loop
u=!0,n())}
// create/init method
function i(t){if(null==t||null==t.binCount||null==t.binSize)throw new Error("You must provide an initial binSize and binCount");l.binSize=Number(t.binSize),l.binCount=Number(t.binCount),null!=t.delay&&(l.delay=Number(t.delay)),(a=p({size:l.binSize,count:l.binCount+2,lwm:0})).lwm(e()),r()}/**
	 * Private variables
	 */
var a,u,l={delay:0,binSize:0,binCount:0};/**
	 * Public API
	 */
/*
	 * Get the model bins
...
return i.model=function(){return a},i.bins=function(){return a.bins()},i.start=function(){return r(),i},i.stop=function(){
// Setting running to false will stop the update loop
return u=!1,i},i.running=function(){return u},i.add=function(t){return a.add(t),i},i.clear=function(){return a.clear(),i},i.binSize=function(t){if(!arguments.length)return l.binSize;if((t=Number(t))<1)throw new Error("Bin size must be a positive integer");return l.binSize=t,a.size(t),a.lwm(e()),i},i.binCount=function(t){if(!arguments.length)return l.binCount;if((t=Number(t))<1)throw new Error("Bin count must be a positive integer");return l.binCount=t,a.count(t+2),a.lwm(e()),i},i(t),i}t.chartDonut=c,t.chartMatrix=function(){function t(t,e){var n=b.g.chart.selectAll(".row text");if(null!=t){
// Set the highlight on the row
var r=t.key;n.classed("active",function(t){return t.key==r})}else
// Now update the style
n.classed("active",!1)}function n(e,n){t(e),z.call("rowMouseover",this,e,n)}function i(e,n){t(),z.call("rowMouseout",this,e,n)}function u(t,e){z.call("rowClick",this,t,e)}function l(t,e){z.call("cellMouseover",this,t,e)}function o(t,e){z.call("cellMouseout",this,t,e)}function c(t,e){z.call("cellClick",this,t,e)}/**
	 * Style stuff
	 */
// Cell dimensions
...
var t=w.length,e=k.length,r=f+d,a=e*r+f,s=t*r+f;
...
/*
		 * Row Join
		 */
var g=b.g.chart.selectAll("g.row").data(w,function(t){return t.key}),z=g.enter().append("g");z.style("opacity","0.1").attr("class","row").attr("transform",function(t,e){return"translate("+h.left+","+(h.top+r*e)+")"}).on("mouseover",n).on("mouseout",i).on("click",u),
...
// Create the DIV element
return m.div=t.append("div").attr("class","sentio bars-vertical"),a.resize(),a},a.data=function(t){return arguments.length?(v=null!=t?t:[],a):v},a.resize=function(){
// Set up the x scale (y is fixed)
return h.x.range([u*c,u]),a},a.redraw=function(){
// Update the x domain
h.x.domain(p.width.getExtent(v)),
// Update the y domain (based on configuration and data)
h.y.domain([0,v.length]),h.y.range([0,(l+o)*v.length]);
// Data Join
var e=m.div.selectAll("div.bar").data(v,f.key),r=e.enter().append("div").attr("class","bar").style("top",h.y.range()[1]-l+"px").style("height",l+"px").on("mouseover",t).on("mouseout",n).on("click",i).style("opacity","0.01"),u=r.append("div").attr("class","bar-label");
// Enter + Update
// Exit
// Update the size of the parent div
return r.merge(e).transition().duration(g).style("opacity","1").style("width",function(t,e){return h.x(f.value(t,e))+"px"}).style("top",function(t,e){return h.y(e)+"px"}).style("left","0px"),u.merge(e.select("div.bar-label")).html(f.label).style("max-width",h.x.range()[1]-10+"px"),e.exit().transition().duration(g).style("opacity","0.01").style("top",h.y.range()[1]-l+"px").remove(),m.div.style("height",h.y.range()[1]+"px"),a},a.width=function(t){return arguments.length?(u=t,a):u},a.barWidthMinRatio=function(t){return arguments.length?(c=t,a):c},a.barHeight=function(t){return arguments.length?(l=t,a):l},a.barPadding=function(t){return arguments.length?(o=t,a):o},a.key=function(t){return arguments.length?(f.key=t,a):f.key},a.value=function(t){return arguments.length?(f.value=t,a):f.value},a.label=function(t){return arguments.length?(f.label=t,a):f.label},a.widthExtent=function(t){return arguments.length?(p.width=t,p.width.getValue(function(t,e){return f.value(t,e)}),a):p.width},a.dispatch=function(t){return arguments.length?a:d},a.duration=function(t){return arguments.length?(g=t,a):g},a},t.controllerRealtimeBins=m,t.controllerResponsiveUnits=/**
 *
 */
function(t){/**
	 * Private Functions
