...
null==e?e=r:(e[0]=Math.min(e[0],r[0]),e[1]=Math.max(e[1],r[1]))}),null==e&&(e=i.getExtent([])),e},r(t),r}function f(t){/**
	 * Private Functions
	 */
function n(t){
// Should probably fire event for new brush state
p=t}function r(){return p&&null!=f}/**
...
function a(t){return(!Array.isArray(t)||2!=t.length||isNaN(t[0])||isNaN(t[1]))&&(t=void 0),t}/**
	 ...
	 * @returns {Function}
	 */
function l(t){return function(e){var n=null!=o.event.selection?i(o.event.selection.map(g.invert)):void 0,r=m,a=!((n===r||null!=n&&null!=r&&n[0]===r[0]&&n[1]===r[1])&&v);
...
a&&h.apply(t,this,e)}}function c(t){var e=void 0;return p&&null!=t&&null!=g&&(e=null!=(e=u.brushSelection(t))&&Array.isArray(e)?i(e.map(g.invert)):void 0),e}function s(t,e){var n=null==(e=a(e))||e[0]>=e[1];
...
v=!0,n?f.move(t,void 0):f.move(t,e.map(g))}function d(t){if(null==t)throw new Error("Must provide a brush and a scale");if(null==t.brush)throw new Error("Must provide a brush");if((f=t.brush).on("brush",l("brush")).on("start",l("start")).on("end",l("end")),null==t.scale)throw new Error("Must provide a scale");g=t.scale,null!=t.enabled&&n(t.enabled)}/**
	 ...
	 */
// The brush object
var f,g,h=e.dispatch("brush","start","end"),m=void 0,p=!1,v=!1;/**
	 * Public API
	 */
...
X.g.voronoi.selectAll("path").data(s).enter().append("path").attr("d",function(t){return null!=t?"M"+t.join("L")+"Z":null}).on("mouseover",o).on("mouseout",c).on("click",g)}e.exit().remove()}function y(){
// Join
...
function a(){/*
		 * Join the data
		 */
var t=y.gChart.selectAll("path.arc").data(x.pie(b),function(t,e){return p.key(t.data,e)}),e=t.enter().append("path").attr("class","arc").on("mouseover",p.mouseover).on("mouseout",p.mouseout).on("click",p.click).each(function(t){this._current={startAngle:0,endAngle:0}}).merge(t);e.transition().duration(g).attrTween("d",function(t){var e=n.interpolate(this._current,t);return this._current=e(0),function(t){return x.arc(e(t))}}),e.attr("key",function(t,e){return p.key(t.data,e)}).attr("fill",function(t,e){return v.color(p.key(t.data,e))}),/*
		 * Exit
		 */
...
var t=w.length,e=k.length,r=g+f,a=e*r+g,s=t*r+g;
...
return a-=o-u,l=Math.max(l-a,h[0]),[l,o]}var u,l="autobrush_timeline_"+Date.now(),o=Date.now(),s={edgeTrigger:.01,zoomInTrigger:.05,zoomOutTrigger:.8,zoomTarget:.2},d=864e5,f=36e5,h=[o-31536e7,o],m=[o-15552e6,o],p=e.dispatch("extentChange","brushChange"),v=g(),x={element:{g:{container:void 0},axisClipPath:void 0},brush:v.brush,dispatch:v.dispatch,init:v.init,resize:v.resize,redraw:v.redraw,setBrush:v.setBrush,xAxis:v.xAxis};
...
var e=0,n=6e4,r=!1,i=null,a=32,u=g();u.yExtent().filter(function(t){var e=u.xValue()(t),n=u.xExtent().getExtent();return e<n[1]&&e>n[0]});/*
	 * Redraw the graphic
	 */
...
function t(t){}
// Layout properties
var n=100,i=24,a=2,u=500,l=e.dispatch("mouseover","mouseout","click"),o={mouseover:function(t,e){l.call("mouseover",this,t,e)},mouseout:function(t,e){l.call("mouseout",this,t,e)},click:function(t,e){l.call("click",this,t,e)},key:function(t){return t.key},value:function(t){return t.value},label:function(t){return t.key+" ("+t.value+")"}},c={x:r.scaleLinear(),y:r.scaleLinear()},d={width:s({defaultValue:[0,10],getValue:function(t,e){return o.value(t,e)}})},f={div:void 0},g=[];/*
	 * Initialize the chart (should only call this once). Performs all initial chart
	 * creation and setup
	 */
/*
