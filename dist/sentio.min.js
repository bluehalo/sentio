...
// Chart create/init method
function v(){}var x="timeline_line_"+Date.now(),y={top:10,right:10,bottom:20,left:40},b=100,k=600,w={xGrid:!1,yGrid:!1,pointEvents:!1},z={valueX:function(t){return t[0]},markerValueX:function(t){return t[0]},markerLabel:function(t){return t[1]},pointRadius:function(){return 2}},A=Date.now(),E={x:s({defaultValue:[A-3e5,A],getValue:function(t,e){return z.valueX(t,e)}}),y:s()},V=g(),M={x:r.scaleTime(),y:r.scaleLinear()},S={x:i.axisBottom().scale(M.x),y:i.axisLeft().ticks(3).scale(M.y),xGrid:i.axisBottom().tickFormat("").tickSizeOuter(0).scale(M.x),yGrid:i.axisLeft().tickFormat("").tickSizeOuter(0).ticks(3).scale(M.y)},B=a.line().x(function(t,e){return M.x(z.valueX(t,e))}),T=a.area().x(function(t,e){return M.x(z.valueX(t,e))}),C=l.voronoi().x(function(t,e){return M.x(t.x,e)}).y(function(t,e){return M.y(t.y,e)}),G=d({brush:u.brushX(),scale:M.x});G.dispatch().on("end",function(){m(),N.call("brushEnd",this,f())}).on("start",function(){m(),N.call("brushStart",this,f())}).on("brush",function(){m(),N.call("brush",this,f())});
...
e[0]=e[1]-a))}return e}(t),function(t){return null!=t&&(null==c||t[1]-t[0]<=c)}(t)){var e=null==n||n[0]!=t[0]||n[1]!=t[1];
// Update the brush
n=t,h.setBrush(n),
...
function(){var t=/**
	 ...
	 */
function(t){var e={pan:!1,zoom:!1};if(null!=t){var n=d.xScale(),r=n.domain()[0],a=t[0],u=t[1],o=n.domain()[1],c=o-r,s=(u-a)/c,g=(a-r)/c<=i.edgeTrigger&&a>l[0],f=(o-u)/c<=i.edgeTrigger&&u<l[1];
...
h.setBrush(n)}var n,r="autobrush_timeline_"+Date.now(),a=Date.now(),i={edgeTrigger:.01,zoomInTrigger:.05,zoomOutTrigger:.8,zoomTarget:.2},u=864e5,l=[a-31536e7,a],o=36e5,c=void 0,s=[a-15552e6,a],g=e.dispatch("extentChange","brushChange"),d=f();
