...
r=r.concat(e.map(function(e,r){return{x:n(e,r),y:t.getValue(e,r),series:t,data:e}}))}),r}function n(t){if(null!=t){var e=X.g.points.selectAll("circle").data(O.map(function(e){return{x:V.valueX(t.data),y:e.getValue(t.data),category:e.category}})),n=e.enter().append("circle"),r=e.selectAll("circle");n.merge(r).attr("class",function(t,e){return t.category}).attr("cx",function(t,e){return T.x(t.x)}).attr("cy",function(t,e){return T.y(t.y)}).attr("r",3)}else X.g.points.selectAll("circle").remove()}function o(t,e){var r=E.pointEvents;"value"===r||"values"===r&&n(t.data),I.call("pointMouseover",this,t.data,e)}function g(t,e){var r=E.pointEvents;"value"===r||"values"===r&&n(),I.call("pointMouseout",this,t.data,e)}function f(t,e){I.call("pointClick",this,t.data,e)}/**
...
// Enter + Update
r.merge(a).attr("d",function(t){return C.y(function(e,n){return T.y(t.getValue(e,n))})(P)}),i.merge(u).attr("d",function(t){return N.y0(T.y.range()[0]).y1(function(e,n){return T.y(t.getValue(e,n))})(P)}),
// Remove the previous voronoi
X.g.voronoi.selectAll("path").remove(),E.pointEvents){
// check range against width
var l=T.x.domain(),c=t(O,P,V.valueX).filter(function(t){
...
X.g.voronoi.selectAll("path").data(c).enter().append("path").attr("d",function(t){return null!=t?"M"+t.join("L")+"Z":null}).on("mouseover",o).on("mouseout",g).on("click",f)}e.exit().remove()}function y(){
// Join
var t=X.g.markers.selectAll(".marker").data(U,V.markerValueX),e=t.enter().append("g").attr("class","marker").on("mouseover",function(t,e){I.call("markerMouseover",this,t,e)}).on("mouseout",function(t,e){I.call("markerMouseout",this,t,e)}).on("click",function(t,e){I.call("markerClick",this,t,e)}),n=e.append("line"),r=e.append("text");n.attr("y1",function(t){return T.y.range()[1]}).attr("y2",function(t){return T.y.range()[0]}),r.attr("dy","0em").attr("y",-3).attr("text-anchor","middle").text(V.markerLabel);
// Enter + Update
var i=t.select("line"),a=t.select("text");n.merge(i).attr("x1",function(t,e){return T.x(V.markerValueX(t,e))}).attr("x2",function(t,e){return T.x(V.markerValueX(t))}),r.merge(a).attr("x",function(t,e){return T.x(V.markerValueX(t))}),
// Exit
t.exit().remove()}
// Chart create/init method
function b(){}var k="timeline_line_"+Date.now(),w={top:10,right:10,bottom:20,left:40},z=100,A=600,E={xGrid:!1,yGrid:!1,pointEvents:!1},V={valueX:function(t){return t[0]},markerValueX:function(t){return t[0]},markerLabel:function(t){return t[1]},pointRadius:function(){return 2}},S=Date.now(),M={x:c({defaultValue:[S-3e5,S],getValue:function(t,e){return V.valueX(t,e)}}),y:c()},B=s(),T={x:r.scaleTime(),y:r.scaleLinear()},G={x:a.axisBottom().scale(T.x),y:a.axisLeft().ticks(3).scale(T.y),xGrid:a.axisBottom().tickFormat("").tickSizeOuter(0).scale(T.x),yGrid:a.axisLeft().tickFormat("").tickSizeOuter(0).ticks(3).scale(T.y)},C=i.line().x(function(t,e){return T.x(V.valueX(t,e))}),N=i.area().x(function(t,e){return T.x(V.valueX(t,e))}),_=l.voronoi().x(function(t,e){return T.x(t.x,e)}).y(function(t,e){return T.y(t.y,e)}),L=d({brush:u.brushX(),scale:T.x});L.dispatch().on("end",function(){I.call("brushEnd",this,h())}).on("start",function(){I.call("brushStart",this,h())}).on("brush",function(){I.call("brush",this,h())});
...
var t=w.length,e=k.length,r=f+g,a=e*r+f,c=t*r+f;
...
var V=E.selectAll("rect.cell").data(function(t){return k.map(function(e,n){return{key:p.key(e,n),value:t.getValue(e,n)}})},p.key);/*
		 * Cell Remove
		 */
return V.enter().append("rect").attr("class","cell").style("opacity","0.1").style("fill",function(t,e){return x.color(t.value)}).attr("x",function(t,e){return x.x(t.key)+f}).attr("y",f).attr("height",g).attr("width",g).on("mouseover",l).on("mouseout",o).on("click",d).merge(V).transition().duration(m).style("opacity","1").attr("x",function(t,e){return x.x(t.key)+f}).style("fill",function(t,e){return x.color(t.value)}),V.exit().transition().duration(m).attr("width",0).style("opacity","0.1").remove(),A},A.data=function(t){return arguments.length?(k=null!=t?t:[],A):k},A.series=function(t){return arguments.length?(w=null!=t?t:[],A):w},A.cellSize=function(t){return arguments.length?(g=t,A):g},A.cellMargin=function(t){return arguments.length?(f=t,A):f},A.margin=function(t){return arguments.length?(h=t,A):h},A.duration=function(t){return arguments.length?(m=t,A):m},A.key=function(t){return arguments.length?(p.key=t,A):p.key},A.colorScale=function(t){return arguments.length?(x.color=t,A):x.color},A.xScale=function(t){return arguments.length?(x.xScale=t,y.x.scale(t),A):x.xScale},A.yScale=function(t){return arguments.length?(x.yScale=t,A):x.yScale},A.xExtent=function(t){return arguments.length?(v.x=t,v.x.getValue(function(e,n){return t(e,n)}),A):v.x},A.valueExtent=function(t){return arguments.length?(v.value=t,A):v.value},A.dispatch=function(){return z},A},t.chartTimeline=g,t.chartAutoBrushTimeline=function(){function t(t){var e=t;
// Crop the brush to max extent
// Make a new copy
// Crop the brush using the max extent
return null!=e&&((e=t.slice())[0]=Math.max(e[0],h[0]),e[1]=Math.min(e[1],h[1])),e}function n(t){return null!=t&&(null==p||t[1]-t[0]<=p)}/**
...
x.call("brushChange",this,e)):
// Don't allow them to apply an invalid brush
b.setBrush(o),y.redraw()}/**
	 * Update the extent
	 */
...
var e=l(o,t);y.xExtent().overrideValue(e),x.call("extentChange",this,e)}}/**
	 ...
	 */
function u(t){var e={pan:!1,zoom:!1};if(null!=t){var n=y.xScale(),r=n.domain()[0],i=t[0],a=t[1],u=n.domain()[1],l=u-r,o=(a-i)/l,c=(i-r)/l<=d.edgeTrigger&&i>h[0],s=(u-a)/l<=d.edgeTrigger&&a<h[1];
// Should we resize and/or recenter?
e.zoom=o>=d.zoomOutTrigger||o<=d.zoomInTrigger,e.pan=c||s}return e}/**
...
return a-=o-u,l=Math.max(l-a,h[0]),[l,o]}var o,c="autobrush_timeline_"+Date.now(),s=Date.now(),d={edgeTrigger:.01,zoomInTrigger:.05,zoomOutTrigger:.8,zoomTarget:.2},f=864e5,h=[s-31536e7,s],m=36e5,p=void 0,v=[s-15552e6,s],x=e.dispatch("extentChange","brushChange"),y=g();
// Turn on brushing and register for brush events
y.brush(!0),y.dispatch().on("brushEnd.internal",r),
...
return b.element.g.container=t,b.init(t),null==o&&(o=v,y.setBrush(o)),b.element.axisClipPath=t.select("svg defs").append("clipPath").attr("id","axis_"+c).append("rect"),b.element.g.container.select("div.sentio.timeline").select("g.axis .x").attr("clip-path","url(#axis_"+c+")"),y.resize(),y},y.redraw=function(){
...
b.element.axisClipPath.attr("transform","translate(0, -"+(n+t.top)+")").attr("width",Math.max(0,e-t.left-t.right+2)).attr("height",Math.max(0,n+t.bottom+t.top))}},y.edgeTrigger=function(t){return arguments.length?(d.edgeTrigger=t,y):d.edgeTrigger},y.zoomInTrigger=function(t){return arguments.length?(d.zoomInTrigger=t,y):d.zoomInTrigger},y.zoomOutTrigger=function(t){return arguments.length?(d.zoomOutTrigger=t,y):d.zoomOutTrigger},y.zoomTarget=function(t){return arguments.length?(d.zoomTarget=t,y):d.zoomTarget},y.maxExtent=function(t){return arguments.length?(h=t,y):h},y.minExtent=function(t){return arguments.length?(f=t,y):f},y.minBrush=function(t){return arguments.length?(m=t,y):m},y.maxBrush=function(t){return arguments.length?(p=t,y):p},y.setBrush=function(t){return r(t),y},y.dispatch=function(){return x},y.timelineDispatch=function(){return b.dispatch},y.brush=function(){return!0},y},t.chartRealtimeTimeline=function(){/*
...
var e=0,n=6e4,r=!1,i=null,a=32,u=g();u.yExtent().filter(function(t){var e=u.xValue()(t),n=u.xExtent().getExtent();return e<n[1]&&e>n[0]}),u.brush(!1),u.pointEvents(!1);/*
	 * Redraw the graphic
	 */
...
function a(t){}
// Layout properties
var u=100,l=24,o=2,s=500,d=e.dispatch("mouseover","mouseout","click"),g={key:function(t){return t.key},value:function(t){return t.value},label:function(t){return t.key+" ("+t.value+")"}},f={x:r.scaleLinear(),y:r.scaleLinear()},h={width:c({defaultValue:[0,10],getValue:function(t,e){return g.value(t,e)}})},m={div:void 0},p=[];/*
	 * Initialize the chart (should only call this once). Performs all initial chart
	 * creation and setup
	 */
/*
...
// Create the DIV element
return m.div=t.append("div").attr("class","sentio bars-vertical"),a.resize(),a},a.data=function(t){return arguments.length?(p=null!=t?t:[],a):p},a.resize=function(){
// Set up the x scale (y is fixed)
return f.x.range([0,u]),a},a.redraw=function(){
// Update the x domain
f.x.domain(h.width.getExtent(p)),
// Update the y domain (based on configuration and data)
f.y.domain([0,p.length]),f.y.range([0,(l+o)*p.length]);
// Data Join
var e=m.div.selectAll("div.bar").data(p,g.key),r=e.enter().append("div").attr("class","bar").style("top",f.y.range()[1]-l+"px").style("height",l+"px").on("mouseover",t).on("mouseout",n).on("click",i).style("opacity","0.01"),u=r.append("div").attr("class","bar-label");
// Enter + Update
// Exit
// Update the size of the parent div
return r.merge(e).transition().duration(s).style("opacity","1").style("width",function(t,e){return f.x(g.value(t,e))+"px"}).style("top",function(t,e){return f.y(e)+"px"}).style("left","0px"),u.merge(e.select("div.bar-label")).html(g.label).style("max-width",f.x.range()[1]-10+"px"),e.exit().transition().duration(s).style("opacity","0.01").style("top",f.y.range()[1]-l+"px").remove(),m.div.style("height",f.y.range()[1]+"px"),a},a.width=function(t){return arguments.length?(u=t,a):u},a.barHeight=function(t){return arguments.length?(l=t,a):l},a.barPadding=function(t){return arguments.length?(o=t,a):o},a.key=function(t){return arguments.length?(g.key=t,a):g.key},a.value=function(t){return arguments.length?(g.value=t,a):g.value},a.label=function(t){return arguments.length?(g.label=t,a):g.label},a.widthExtent=function(t){return arguments.length?(h.width=t,h.width.getValue(function(t,e){return g.value(t,e)}),a):h.width},a.dispatch=function(t){return arguments.length?a:d},a.duration=function(t){return arguments.length?(s=t,a):s},a},t.controllerRealtimeBins=/*
...
function n(t){null==t&&(t={}),null!=t.minTrigger&&(r.minTrigger=t.minTrigger),null!=t.maxTrigger&&(r.maxTrigger=t.maxTrigger)}/**
	 ...
	 */
// Configuration
var r={minTrigger:30,maxTrigger:300},i=[{key:"second",value:1e3},{key:"minute",value:6e4},{key:"hour",value:36e5},{key:"day",value:864e5},{key:"month",value:2592e6},{key:"year",value:31536e6}],a=i[0];/**
	 * Public API
	 */
// Initialize the model
return n.getUnit=function(t){
// If we're good, just return the current unit
var n=a;if(0===e(t,n))return a;
// Loop while there's too many points
for(
// We weren't good, so find a new unit by searching smallest to largest
var r=0;0<e(t,i[r++])&&r<i.length;);return a=i[r],n},n.units=function(t){return arguments.length?(i=t,n):i},n.currentUnit=function(t){return arguments.length?(a=t,n):a},n(t),n},t.timelineBrush=d,t.modelBins=f,t.modelExtent=c,t.modelMultiExtent=s,Object.defineProperty(t,"__esModule",{value:!0})});