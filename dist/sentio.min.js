...
!function(e,t){"object"==typeof exports&&"undefined"!=typeof module?t(exports,require("d3-dispatch"),require("d3-interpolate"),require("d3-scale"),require("d3-shape"),require("d3-axis"),require("d3-brush"),require("d3-selection")):"function"==typeof define&&define.amd?define(["exports","d3-dispatch","d3-interpolate","d3-scale","d3-shape","d3-axis","d3-brush","d3-selection"],t):t(e.sentio={},e.d3,e.d3,e.d3,e.d3,e.d3,e.d3,e.d3)}(this,function(e,t,n,r,u,a,i,l){"use strict";function o(e){/**
	 * Private Functions
	 */
function t(e){if(null==e||2!==e.length||isNaN(e[0])||isNaN(e[1])||e[0]>=e[1])throw new Error("Default extent must be a two element ordered array of numbers");l.defaultValue=e}function n(e){if(null!=e&&2!==e.length)throw new Error("Extent override must be a two element array or null/undefined");l.overrideValue=e}function r(e){if(null!=e&&2!==e.length)throw new Error("Extent padding must be a two element array or null/undefined");l.paddingValue=e}function u(e){if("function"!=typeof e)throw new Error("Value getter must be a function");o.getValue=e}function a(e){if("function"!=typeof e)throw new Error("Filter must be a function");o.filter=e}/*
	 * Constructor/initialization method
	 */
function i(e){null!=e&&(null!=e.defaultValue&&t(e.defaultValue),null!=e.overrideValue&&n(e.overrideValue),null!=e.paddingValue&&r(e.paddingValue),null!=e.getValue&&u(e.getValue),null!=e.filter&&a(e.filter))}/**
	 * Private variables
	 */
// Configuration
...
return i.defaultValue=function(e){return arguments.length?(t(e),i):l.defaultValue},i.overrideValue=function(e){return arguments.length?(n(e),i):l.overrideValue},i.paddingValue=function(e){return arguments.length?(r(e),i):l.paddingValue},i.getValue=function(e){return arguments.length?(u(e),i):o.getValue},i.filter=function(e){return arguments.length?(a(e),i):o.filter},i.getExtent=function(e){var t,n=l.overrideValue;
...
null!=n&&(null!=n[0]&&(t[0]=n[0]),null!=n[1]&&(t[1]=n[1]));var u=l.paddingValue;null==u||null==u[0]||null!=n&&null!=n[0]||(
// Only apply the padding if there was no override
t[0]-=l.paddingValue[0]),null==u||null==u[1]||null!=n&&null!=n[1]||(t[1]+=l.paddingValue[1])}else
...
function n(e){null!=e&&null!=e.extent&&t(e.extent)}/**
	 * Private variables
	 */
var r={values:function(e){return e.values}},u=o();/**
	 * Public API
	 */
/*
...
/*
	 ...
	 */
// Initialize the model
return n.extent=function(e){return arguments.length?(t(e),n):u},n.values=function(e){return arguments.length?(r.values=e,n):r.values},n.getExtent=function(e){var t;
// In case there was no data
return e.forEach(function(e,n){var a=u.getExtent(r.values(e,n));null==t?t=a:(t[0]=Math.min(t[0],a[0]),t[1]=Math.max(t[1],a[1]))}),null==t&&(t=u.getExtent([])),t},n(e),n}function s(e){/**
	 * Private Functions
	 */
function n(e){
...
function a(e){return(!Array.isArray(e)||2!=e.length||isNaN(e[0])||isNaN(e[1]))&&(e=void 0),e}/**
	 ...
	 * @returns {Function}
	 */
function o(e){return function(t){var n=null!=l.event.selection?u(l.event.selection.map(g.invert)):void 0,r=m,a=!((n===r||null!=n&&null!=r&&n[0]===r[0]&&n[1]===r[1])&&p);
...
a&&h.apply(e,this,t)}}function c(e){var t=void 0;return v&&null!=e&&null!=g&&(t=null!=(t=i.brushSelection(e))&&Array.isArray(t)?u(t.map(g.invert)):void 0),t}function s(e,t){var n=null==(t=a(t))||t[0]>=t[1];
...
// Join
var e=A.g.plots.selectAll(".plot").data(C,y.seriesKey),t=e.enter().append("g").attr("class","plot"),n=t.append("g").append("path").attr("class",function(e){return(e.cssClass?e.cssClass:"")+" line"}),r=t.append("g").append("path").attr("class",function(e){return(e.cssClass?e.cssClass:"")+" area"}),u=e.select(".line"),a=e.select(".area");
// Enter + Update
n.merge(u).datum(y.seriesValues).attr("d",E),r.merge(a).datum(y.seriesValues).attr("d",M.y0(V.y.range()[0])),e.exit().remove()}function h(){
// Join
...
// Enter + Update
var u=e.select("line"),a=e.select("text");n.merge(u).attr("x1",function(e,t){return V.x(y.markerValueX(e,t))}).attr("x2",function(e,t){return V.x(y.markerValueX(e))}),r.merge(a).attr("x",function(e,t){return V.x(y.markerValueX(e))}),
// Exit
e.exit().remove()}var m="timeline_line_"+Date.now(),v={top:10,right:10,bottom:20,left:40},p=100,x=600,y={valueX:function(e){return e[0]},valueY:function(e){return e[1]},markerValueX:function(e){return e[0]},markerLabel:function(e){return e[1]},seriesKey:function(e){return e.key},seriesValues:function(e){return e.values},seriesLabel:function(e){return e.label}},b=Date.now(),w={x:o({defaultValue:[b-3e5,b],getValue:function(e,t){return y.valueX(e,t)}}),y:o({getValue:function(e,t){return y.valueY(e,t)}})},k=c().values(function(e,t){return y.seriesValues(e,t)}),V={x:r.scaleTime(),y:r.scaleLinear()},z={x:a.axisBottom().scale(V.x),y:a.axisLeft().scale(V.y).ticks(3)},A={svg:void 0,g:{container:void 0,plots:void 0,xAxis:void 0,yAxis:void 0,markers:void 0,brush:void 0},plotClipPath:void 0,markerClipPath:void 0},E=u.line();E.x(function(e,t){return V.x(y.valueX(e,t))}),E.y(function(e,t){return V.y(y.valueY(e,t))});
// Area generator for the plot
var M=u.area();M.x(function(e,t){return V.x(y.valueX(e,t))}),M.y1(function(e,t){return V.y(y.valueY(e,t))});
// Brush Management
...
// pad above the hwm
for(;c[c.length-1][0]<l.hwm-l.size;)c.push([c[c.length-1][0]+l.size,o.createSeed()]);o.afterUpdate&&o.afterUpdate.call(i,c,s,t)}function u(e){var n=s;e.forEach(function(e,n){var r=t(o.getKey(e,n));if(r>=0&&r<c.length){var u=o.getValue(e,n),a=o.countBin(c[r]);o.updateBin.call(i,c[r],u,n),s+=o.countBin(c[r])-a}}),o.afterAdd&&o.afterAdd.call(i,c,s,n)}function a(){c.length=0,s=0}/*
	 * Constructor/initialization method
	 */
...
/**
	 ...
	 */
// Initialize the model
return i.set=function(e){return a(),r(),u(e),i},i.clear=function(){return a(),r(),i},i.add=function(e){return u(e),i},i.lwm=function(e){if(!arguments.length)return l.lwm;var t=l.lwm;
// the difference between watermarks is not a multiple of the bin size, so we need to reset
return l.lwm=Number(e),n(),(t-l.lwm)%l.size!=0&&a(),r(),i},i.hwm=function(){return l.hwm},i.getKey=function(e){return arguments.length?(o.getKey=e,a(),r(),i):o.getKey},i.getValue=function(e){return arguments.length?(o.getValue=e,a(),r(),i):o.getValue},i.updateBin=function(e){return arguments.length?(o.updateBin=e,a(),r(),i):o.updateBin},i.createSeed=function(e){return arguments.length?(o.createSeed=e,a(),r(),i):o.createSeed},i.countBin=function(e){return arguments.length?(o.countBin=e,a(),r(),i):o.countBin},i.afterAdd=function(e){return arguments.length?(o.afterAdd=e,i):o.afterAdd},i.afterUpdate=function(e){return arguments.length?(o.afterUpdate=e,i):o.afterUpdate},i.size=function(e){if(!arguments.length)return l.size;if((e=Number(e))<1)throw new Error("Bin size must be a positive integer");
// Only change stuff if the size actually changes
return e!==l.size&&(l.size=e,n(),a(),r()),i},i.count=function(e){if(!arguments.length)return l.count;if((e=Number(e))<1)throw new Error("Bin count must be a positive integer");
...
var u=v.key(e,t);n.classed("active",function(e,t){return v.key(e,t)==u}),r.classed("active",function(e,t){return v.key(e.data,t)==u})}else n.classed("active",!1),r.classed("active",!1)},mouseover:function(e,t){e=v.getEventElement(e,t),v.updateActiveElement(e,t),m.call("mouseover",this,e,t)},mouseout:function(e,t){e=v.getEventElement(e,t),v.updateActiveElement(),m.call("mouseout",this,e,t)},click:function(e,t){e=v.getEventElement(e,t),m.call("click",this,e,t)},key:function(e){return e.key},value:function(e){return e.value},label:function(e){return e.key+" ("+e.value+")"}},p={color:r.scaleOrdinal(r.schemeCategory10)},x={arc:u.arc().padAngle(.01),pie:u.pie().value(function(e,t){return v.value(e,t)}).sort(null)},y={div:void 0,svg:void 0,gChart:void 0,legend:void 0},b=[];/*
...
var t=m.length,r=[];t>0&&(r=s.seriesValues(m[0]));var a=r.length,l=n+e,o=a*l+n,c=t*l+n;
// scale the svg to the right size
h.svg.attr("width",o+u.left+u.right).attr("height",c+u.top+u.bottom),
// Configure the scales
d.x.domain(f.x.getExtent(r)).range([0,o-n-l]),d.color.domain(f.multi.values(s.seriesValues).extent(f.value).getExtent(m)),
// Draw the x axis
h.g.xAxis.attr("transform","translate("+(u.left+n+e/2)+","+u.top+")"),h.g.xAxis.call(g.x);/**
		 * Chart Manipulation
		 */
/*
		 * Row Join
		 */
var p=h.g.chart.selectAll("g.row").data(m,s.seriesKey),x=p.enter().append("g");x.style("opacity","0.1").attr("class","row").attr("transform",function(e,t){return"translate("+u.left+","+(u.top+l*t)+")"}).on("mouseover",s.rowMouseover).on("mouseout",s.rowMouseout).on("click",s.rowClick),
...
var y=x.merge(p);y.transition().duration(i).style("opacity","1").attr("transform",function(e,t){return"translate("+u.left+","+(u.top+l*t)+")"}),
...
var b=y.selectAll("rect.cell").data(s.seriesValues,s.key);/*
		 * Cell Remove
		 */
return b.enter().append("rect").attr("class","cell").style("opacity","0.1").style("fill",function(e,t){return d.color(s.value(e,t))}).attr("x",function(e,t){return d.x(s.key(e,t))+n}).attr("y",n).attr("height",e).attr("width",e).on("mouseover",s.cellMouseover).on("mouseout",s.cellMouseout).on("click",s.cellClick).merge(b).transition().duration(i).style("opacity","1").attr("x",function(e,t){return d.x(s.key(e,t))+n}).style("fill",function(e,t){return d.color(s.value(e,t))}),b.exit().transition().duration(i).attr("width",0).style("opacity","0.1").remove(),v},v.cellSize=function(t){return arguments.length?(e=t,v):e},v.cellMargin=function(e){return arguments.length?(n=e,v):n},v.margin=function(e){return arguments.length?(u=e,v):u},v.duration=function(e){return arguments.length?(i=e,v):i},v.seriesKey=function(e){return arguments.length?(s.seriesKey=e,v):s.seriesKey},v.seriesLabel=function(e){return arguments.length?(s.seriesLabel=e,v):s.seriesLabel},v.seriesValues=function(e){return arguments.length?(s.seriesValues=e,v):s.seriesValues},v.key=function(e){return arguments.length?(s.key=e,v):s.key},v.value=function(e){return arguments.length?(s.value=e,v):s.value},v.colorScale=function(e){return arguments.length?(d.color=e,v):d.color},v.xScale=function(e){return arguments.length?(d.xScale=e,g.x.scale(e),v):d.xScale},v.yScale=function(e){return arguments.length?(d.yScale=e,v):d.yScale},v.xExtent=function(e){return arguments.length?(f.x=e,f.x.getValue(function(t,n){return e(t,n)}),v):f.x},v.valueExtent=function(e){return arguments.length?(f.value=e,f.value.getValue(function(t,n){return e(t,n)}),v):f.value},v.dispatch=function(){return l},v},e.chartTimeline=f,e.chartAutoBrushTimeline=function(){function e(e){var t=e;
// Crop the brush to max extent
// Make a new copy
// Crop the brush using the max extent
return null!=t&&((t=e.slice())[0]=Math.max(t[0],s[0]),t[1]=Math.min(t[1],s[1])),t}/**
...
function n(t){
// Ensure the brush is valid
null!=(t=e(t))&&t[1]-t[0]>c?(
// Update the brush
i=t,m.setBrush(t),
// Update the extent as necessary
r(),
// Fire the brush change event
g.call("brushChange",this,t)):
// Don't allow them to apply an invalid brush
m.setBrush(i),h.redraw()}/**
	 * Update the extent
	 */
function r(){if(u(i)){
// Update the Extent and fire the event
var e=a(i);h.xExtent().overrideValue(e),g.call("extentChange",this,e)}}/**
	 * Check to see if the extent needs to change
	 * - Checks boundaries and zoom level
	 *
	 * @param brush
	 */
function u(e){if(null!=e){var t=h.xScale(),n=t.domain()[0],r=e[0],u=e[1],a=t.domain()[1],i=a-n,l=(u-r)/i,c=(r-n)/i<=o.edgeTrigger&&r>s[0],f=(a-u)/i<=o.edgeTrigger&&u<s[1],d=l>=o.zoomOutTrigger||l<=o.zoomInTrigger,g=c||f;return d||g}return!1}/**
	 * Given the brush, determine the new xExtent that should be applied
	 * @param brush
	 * @returns {[*,*]}
	 */
function a(e){var t=e[0],n=e[1],r=Math.max((n-t)/o.zoomTarget,c),u=t+(n-t)/2,a=Math.max(u-r/2,s[0]);
...
return r-=i-u,a=Math.max(a-r,s[0]),[a,i]}/**
	 * Auto brush configuration
	 */
var i,l=Date.now(),o={edgeTrigger:.01,zoomInTrigger:.05,zoomOutTrigger:.8,zoomTarget:.2},c=864e5,s=[l-31536e7,l],d=[l-15552e6,l],g=t.dispatch("extentChange","brushChange"),h=f(),m={brush:h.brush,dispatch:h.dispatch,element:{},init:h.init,resize:h.resize,redraw:h.redraw,setBrush:h.setBrush,xAxis:h.xAxis};
// Set up default look and feel
// Initialization of the timline and auto brush
// Redraw the auto brush
// Basic Getters/Setters
// Cannot disable the brush
return h.margin({top:2,right:10,bottom:2,left:10}),h.xAxis().ticks(6),h.yAxis(null),h.init=function(e){
// Initialize the timeline
// Turn on brushing and register for brush events
// Grab and persist some important elements
// Set the initial brush
return m.init(e),m.brush(!0),m.dispatch().on("brushend.internal",n),m.element.div=e.select("div.sentio.timeline"),null==i&&(i=d,h.setBrush(i)),h},h.redraw=function(){
...
// Call it to redraw
return m.redraw(),h.xAxis().tickSize(-h.height()+h.margin().top+h.margin().bottom),m.element.div.selectAll("g.x.axis g.tick text").attr("y","3").attr("dy","-0.71em").attr("dx","0.35em").attr("text-anchor","start").attr("pointer-events","none"),null!=h.xAxis()&&m.element.div.select("g.x.axis").call(h.xAxis()),h},h.edgeTrigger=function(e){return arguments.length?(o.edgeTrigger=e,h):o.edgeTrigger},h.zoomInTrigger=function(e){return arguments.length?(o.zoomInTrigger=e,h):o.zoomInTrigger},h.zoomOutTrigger=function(e){return arguments.length?(o.zoomOutTrigger=e,h):o.zoomOutTrigger},h.zoomTarget=function(e){return arguments.length?(o.zoomTarget=e,h):o.zoomTarget},h.maxExtent=function(e){return arguments.length?(s=e,h):s},h.maxZoom=function(e){return arguments.length?(c=e,h):c},h.setBrush=function(e){return n(e),h},h.dispatch=function(){return g},h.rawDispatch=function(){return m.dispatch},h.brush=function(){return!0},h},e.chartRealtimeTimeline=function(){/*
...
var t=0,n=6e4,r=!1,u=null,a=32,i=f();i.yExtent().filter(function(e){var t=i.xValue()(e),n=i.xExtent().getExtent();return t<n[1]&&t>n[0]});/*
	 * Redraw the graphic
	 */
var l=i.redraw;return i.redraw=function(){
// Update the x domain (to the latest time window)
var e=new Date;return i.xExtent().overrideValue([e-t-n,e-t]),l(),i},i.start=function(){if(!r)return r=!0,e(),i},i.stop=function(){return r=!1,null!=u&&window.clearTimeout(u),i},i.restart=function(){return i.stop(),i.start(),i},i.interval=function(e){return arguments.length?(n=e,i):n},i.delay=function(e){return arguments.length?(t=e,i):t},i.fps=function(e){return arguments.length?(a=e,r&&i.restart(),i):a},i},e.chartVerticalBars=function(){
// Chart create/init method
function e(e){}
// Layout properties
var n=100,u=24,a=2,i=500,l=t.dispatch("mouseover","mouseout","click"),c={mouseover:function(e,t){l.call("mouseover",this,e,t)},mouseout:function(e,t){l.call("mouseout",this,e,t)},click:function(e,t){l.call("click",this,e,t)},key:function(e){return e.key},value:function(e){return e.value},label:function(e){return e.key+" ("+e.value+")"}},s={x:r.scaleLinear(),y:r.scaleLinear()},f={width:o({defaultValue:[0,10],getValue:function(e,t){return c.value(e,t)}})},d={div:void 0},g=[];/*
	 * Initialize the chart (should only call this once). Performs all initial chart
	 * creation and setup
	 */
/*
...
l=!1}
// create/init method
function a(e){if(null==e||null==e.binCount||null==e.binSize)throw new Error("You must provide an initial binSize and binCount");o.binSize=Number(e.binSize),o.binCount=Number(e.binCount),null!=e.delay&&(o.delay=Number(e.delay)),(i=d({size:o.binSize,count:o.binCount+2,lwm:0})).lwm(t()),r()}/**
	 * Private variables
	 */
...
return a.model=function(){return i},a.bins=function(){return i.bins()},a.start=function(){return r(),a},a.stop=function(){return u(),a},a.running=function(){return l},a.add=function(e){return i.add(e),a},a.clear=function(){return i.clear(),a},a.binSize=function(e){if(!arguments.length)return o.binSize;if((e=Number(e))<1)throw new Error("Bin size must be a positive integer");return o.binSize=e,i.size(e),i.lwm(t()),a},a.binCount=function(e){if(!arguments.length)return o.binCount;if((e=Number(e))<1)throw new Error("Bin count must be a positive integer");return o.binCount=e,i.count(e+2),i.lwm(t()),a},a(e),a},e.timelineBrush=s,e.modelBins=d,e.modelExtent=o,e.modelMultiExtent=c,Object.defineProperty(e,"__esModule",{value:!0})});