...
m=t}function r(){return m&&null!=g}/**
...
function a(t){return(!Array.isArray(t)||2!=t.length||isNaN(t[0])||isNaN(t[1]))&&(t=void 0),t}/**
	 ...
	 * @returns {Function}
	 */
function l(t){return function(e){var n=null!=o.event.selection?i(o.event.selection.map(f.invert)):void 0,r=p,a=!((n===r||null!=n&&null!=r&&n[0]===r[0]&&n[1]===r[1])&&v);
...
a&&h.apply(t,this,e)}}function c(t){var e=void 0;return m&&null!=t&&null!=f&&(e=null!=(e=u.brushSelection(t))&&Array.isArray(e)?i(e.map(f.invert)):void 0),e}function s(t,e){var n=null==(e=a(e))||e[0]>=e[1];
...
v=!0,n?g.move(t,void 0):g.move(t,e.map(f))}function d(t){if(null==t)throw new Error("Must provide a brush and a scale");if(null==t.brush)throw new Error("Must provide a brush");if((g=t.brush).on("brush",l("brush")).on("start",l("start")).on("end",l("end")),null==t.scale)throw new Error("Must provide a scale");f=t.scale,null!=t.enabled&&n(t.enabled)}/**
	 ...
	 */
// The brush object
var g,f,h=e.dispatch("brush","start","end"),p=void 0,m=!1,v=!1;/**
	 * Public API
	 */
...
var e=M.x.getExtent(P);p(null!=e&&Array.isArray(e)&&2==e.length?[Math.max(e[0],t[0]),Math.min(e[1],t[1])]:void 0)}X.g.brush.style("display",L.enabled()?"unset":"none").call(L.brush())}function v(){null!=C.x&&X.g.xAxis.call(C.x),null!=C.xGrid&&V.xGrid&&X.g.xAxisGrid.call(C.xGrid),null!=C.y&&X.g.yAxis.call(C.y),null!=C.yGrid&&V.yGrid&&X.g.yAxisGrid.call(C.yGrid)}function x(){
// Join
...
X.g.voronoi.selectAll("path").remove(),V.pointEvents){
...
// Resize the brush
return X.svg.attr("width",A).attr("height",z),X.g.container.attr("transform","translate("+w.left+","+w.top+")"),G.x.range([0,Math.max(0,A-w.left-w.right)]),G.y.range([Math.max(0,z-w.top-w.bottom),0]),X.plotClipPath.attr("transform","translate(0, -1)").attr("width",Math.max(0,G.x.range()[1])+2).attr("height",Math.max(0,G.y.range()[0])+2),X.markerClipPath.attr("transform","translate(0, -"+w.top+")").attr("width",Math.max(0,A-w.left-w.right)).attr("height",Math.max(0,z-w.bottom)),_.extent([[0,0],[A-w.left-w.right,z-w.top-w.bottom]]),X.g.xAxis.attr("transform","translate(0,"+G.y.range()[0]+")"),X.g.xAxisGrid.attr("transform","translate(0,"+G.y.range()[0]+")"),V.xGrid?C.xGrid.tickSizeInner(-(z-w.top-w.bottom)):C.xGrid.tickSizeInner(0),V.yGrid?C.yGrid.tickSizeInner(-(A-w.left-w.right)):C.yGrid.tickSizeInner(0),X.g.brush.selectAll("rect").attr("y",-1).attr("x",0).attr("width",G.x.range()[1]).attr("height",G.y.range()[0]+2),L.brush().extent([[0,0],[G.x.range()[1],G.y.range()[0]+2]]),m(t),b},b.redraw=function(){
// Need to grab the brush extent before we change anything
var t=h();
// Update the x domain (to the latest time window)
// Update the y domain (based on configuration and data)
// Update the plot elements
return G.x.domain(M.x.getExtent(P)),G.y.domain(B.extent(M.y).series(O).getExtent(P)),v(),x(),y(),m(t),b},b.width=function(t){return arguments.length?(A=t,b):A},b.height=function(t){return arguments.length?(z=t,b):z},b.margin=function(t){return arguments.length?(w=t,b):w},b.showXGrid=function(t){return arguments.length?(V.xGrid=t,b):V.xGrid},b.showYGrid=function(t){return arguments.length?(V.yGrid=t,b):V.yGrid},b.showGrid=function(t){return V.xGrid=V.yGrid=t,b},b.pointEvents=function(t){return arguments.length?(V.pointEvents=t,b):V.pointEvents},b.curve=function(t){return arguments.length?(T.curve(t),N.curve(t),b):T.curve()},b.xAxis=function(t){return arguments.length?(C.x=t,b):C.x},b.xGridAxis=function(t){return arguments.length?(C.xGrid=t,b):C.xGrid},b.yAxis=function(t){return arguments.length?(C.y=t,b):C.y},b.yGridAxis=function(t){return arguments.length?(C.yGrid=t,b):C.yGrid},b.xScale=function(t){return arguments.length?(G.x=t,null!=C.x&&C.x.scale(t),null!=C.xGrid&&C.xGrid.scale(t),null!=L&&L.scale(t),b):G.x},b.yScale=function(t){return arguments.length?(G.y=t,null!=C.y&&C.y.scale(t),null!=C.yGrid&&C.yGrid.scale(t),b):G.y},b.xValue=function(t){return arguments.length?(E.valueX=t,b):E.valueX},b.yExtent=function(t){return arguments.length?(M.y=t,b):M.y},b.xExtent=function(t){return arguments.length?(M.x=t,b):M.x},b.markerXValue=function(t){return arguments.length?(E.markerValueX=t,b):E.markerValueX},b.markerLabel=function(t){return arguments.length?(E.markerValueLabel=t,b):E.markerValueLabel},b.dispatch=function(t){return arguments.length?b:I},b.brush=function(t){return arguments.length?(L.enabled(t),b):L.enabled()},b.setBrush=function(t){return p(t),b},b.getBrush=function(){return h()},b}/**
...
function a(){/*
		 * Join the data
		 */
var t=y.gChart.selectAll("path.arc").data(x.pie(b),function(t,e){return m.key(t.data,e)}),e=t.enter().append("path").attr("class","arc").on("mouseover",m.mouseover).on("mouseout",m.mouseout).on("click",m.click).each(function(t){this._current={startAngle:0,endAngle:0}}).merge(t);e.transition().duration(f).attrTween("d",function(t){var e=n.interpolate(this._current,t);return this._current=e(0),function(t){return x.arc(e(t))}}),e.attr("key",function(t,e){return m.key(t.data,e)}).attr("fill",function(t,e){return v.color(m.key(t.data,e))}),/*
		 * Exit
		 */
...
var V=z.merge(d);V.transition().duration(p).style("opacity","1").attr("transform",function(t,e){return"translate("+h.left+","+(h.top+r*e)+")"}),
// Update the series labels in case they changed
V.select("text.series.label").text(function(t){return t.label}),/*
		 * Row Exit
		 */
d.exit().transition().duration(p).style("opacity","0.1").remove();/*
		 * Cell Join - Will be done on row enter + exit
		 */
var E=V.selectAll("rect.cell").data(function(t){return k.map(function(e,n){return{key:m.key(e,n),value:t.getValue(e,n)}})},m.key);/*
		 * Cell Remove
		 */
return E.enter().append("rect").attr("class","cell").style("opacity","0.1").style("fill",function(t,e){return x.color(t.value)}).attr("x",function(t,e){return x.x(t.key)+f}).attr("y",f).attr("height",g).attr("width",g).on("mouseover",l).on("mouseout",o).on("click",c).merge(E).transition().duration(p).style("opacity","1").attr("x",function(t,e){return x.x(t.key)+f}).style("fill",function(t,e){return x.color(t.value)}),E.exit().transition().duration(p).attr("width",0).style("opacity","0.1").remove(),A},A.data=function(t){return arguments.length?(k=null!=t?t:[],A):k},A.series=function(t){return arguments.length?(w=null!=t?t:[],A):w},A.cellSize=function(t){return arguments.length?(g=t,A):g},A.cellMargin=function(t){return arguments.length?(f=t,A):f},A.margin=function(t){return arguments.length?(h=t,A):h},A.duration=function(t){return arguments.length?(p=t,A):p},A.key=function(t){return arguments.length?(m.key=t,A):m.key},A.colorScale=function(t){return arguments.length?(x.color=t,A):x.color},A.xScale=function(t){return arguments.length?(x.xScale=t,y.x.scale(t),A):x.xScale},A.yScale=function(t){return arguments.length?(x.yScale=t,A):x.yScale},A.xExtent=function(t){return arguments.length?(v.x=t,v.x.getValue(function(e,n){return t(e,n)}),A):v.x},A.valueExtent=function(t){return arguments.length?(v.value=t,A):v.value},A.dispatch=function(){return z},A},t.chartTimeline=f,t.chartAutoBrushTimeline=
...
var e=a(u,t);v.xExtent().overrideValue(e),m.call("extentChange",this,e)}}/**
...
return a-=o-u,l=Math.max(l-a,h[0]),[l,o]}var u,l="autobrush_timeline_"+Date.now(),o=Date.now(),s={edgeTrigger:.01,zoomInTrigger:.05,zoomOutTrigger:.8,zoomTarget:.2},d=864e5,g=36e5,h=[o-31536e7,o],p=[o-15552e6,o],m=e.dispatch("extentChange","brushChange"),v=f(),x={element:{g:{container:void 0},axisClipPath:void 0},brush:v.brush,dispatch:v.dispatch,init:v.init,resize:v.resize,redraw:v.redraw,setBrush:v.setBrush,xAxis:v.xAxis};
...
return x.element.g.container=t,x.init(t),x.brush(!0),x.dispatch().on("brushEnd.internal",n),null==u&&(u=p,v.setBrush(u)),x.element.axisClipPath=t.select("svg defs").append("clipPath").attr("id","axis_"+l).append("rect"),x.element.g.container.select("div.sentio.timeline").select("g.axis .x").attr("clip-path","url(#axis_"+l+")"),v.resize(),v},v.redraw=function(){
...
// Update the x domain (to the latest time window)
var t=new Date;return u.xExtent().overrideValue([t-e-n,t-e]),l(),u},u.start=function(){if(!r)return r=!0,t(),u},u.stop=function(){return r=!1,null!=i&&window.clearTimeout(i),u},u.restart=function(){return u.stop(),u.start(),u},u.interval=function(t){return arguments.length?(n=t,u):n},u.delay=function(t){return arguments.length?(e=t,u):e},u.fps=function(t){return arguments.length?(a=t,r&&u.restart(),u):a},u},t.chartVerticalBars=function(){function t(t,e){d.call("mouseover",this,t,e)}function n(t,e){d.call("mouseout",this,t,e)}function i(t,e){d.call("click",this,t,e)}
// Chart create/init method
function a(t){}
// Layout properties
var u=100,l=24,o=2,c=500,d=e.dispatch("mouseover","mouseout","click"),g={key:function(t){return t.key},value:function(t){return t.value},label:function(t){return t.key+" ("+t.value+")"}},f={x:r.scaleLinear(),y:r.scaleLinear()},h={width:s({defaultValue:[0,10],getValue:function(t,e){return g.value(t,e)}})},p={div:void 0},m=[];/*
	 * Initialize the chart (should only call this once). Performs all initial chart
	 * creation and setup
	 */
/*
...
return f.x.range([0,u]),a},a.redraw=function(){
// Update the x domain
f.x.domain(h.width.getExtent(m)),
// Update the y domain (based on configuration and data)
f.y.domain([0,m.length]),f.y.range([0,(l+o)*m.length]);
// Data Join
var e=p.div.selectAll("div.bar").data(m,g.key),r=e.enter().append("div").attr("class","bar").style("top",f.y.range()[1]-l+"px").style("height",l+"px").on("mouseover",t).on("mouseout",n).on("click",i).style("opacity","0.01"),u=r.append("div").attr("class","bar-label");
// Enter + Update
// Exit
// Update the size of the parent div
return r.merge(e).transition().duration(c).style("opacity","1").style("width",function(t,e){return f.x(g.value(t,e))+"px"}).style("top",function(t,e){return f.y(e)+"px"}).style("left","0px"),u.merge(e.select("div.bar-label")).html(g.label).style("max-width",f.x.range()[1]-10+"px"),e.exit().transition().duration(c).style("opacity","0.01").style("top",f.y.range()[1]-l+"px").remove(),p.div.style("height",f.y.range()[1]+"px"),a},a.width=function(t){return arguments.length?(u=t,a):u},a.barHeight=function(t){return arguments.length?(l=t,a):l},a.barPadding=function(t){return arguments.length?(o=t,a):o},a.key=function(t){return arguments.length?(g.key=t,a):g.key},a.value=function(t){return arguments.length?(g.value=t,a):g.value},a.label=function(t){return arguments.length?(g.label=t,a):g.label},a.widthExtent=function(t){return arguments.length?(h.width=t,h.width.getValue(function(t,e){return g.value(t,e)}),a):h.width},a.dispatch=function(t){return arguments.length?a:d},a.duration=function(t){return arguments.length?(c=t,a):c},a},t.controllerRealtimeBins=/*
