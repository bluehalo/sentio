...
// Update the x domain (to the latest time window)
var t=new Date;return u.xExtent().overrideValue([t-e-n,t-e]),l(),u},u.start=function(){if(!r)return r=!0,t(),u},u.stop=function(){return r=!1,null!=i&&window.clearTimeout(i),u},u.restart=function(){return u.stop(),u.start(),u},u.interval=function(t){return arguments.length?(n=t,u):n},u.delay=function(t){return arguments.length?(e=t,u):e},u.fps=function(t){return arguments.length?(a=t,r&&u.restart(),u):a},u.brush=function(t){return!1},u},t.chartVerticalBars=function(){function t(t,e){g.call("mouseover",this,t,e)}function n(t,e){g.call("mouseout",this,t,e)}function i(t,e){g.call("click",this,t,e)}
// Chart create/init method
function a(t){}
// Layout properties
var u=100,l=24,o=2,s=500,g=e.dispatch("mouseover","mouseout","click"),d={key:function(t){return t.key},value:function(t){return t.value},label:function(t){return t.key+" ("+t.value+")"}},f={x:r.scaleLinear(),y:r.scaleLinear()},h={width:c({defaultValue:[0,10],getValue:function(t,e){return d.value(t,e)}})},m={div:void 0},p=[];/*
	 * Initialize the chart (should only call this once). Performs all initial chart
	 * creation and setup
	 */
/*
...
// Data Join
var e=m.div.selectAll("div.bar").data(p,d.key),r=e.enter().append("div").attr("class","bar").style("top",f.y.range()[1]-l+"px").style("height",l+"px").on("mouseover",t).on("mouseout",n).on("click",i).style("opacity","0.01"),u=r.append("div").attr("class","bar-label");
// Enter + Update
// Exit
// Update the size of the parent div
return r.merge(e).transition().duration(s).style("opacity","1").style("width",function(t,e){return f.x(d.value(t,e))+"px"}).style("top",function(t,e){return f.y(e)+"px"}).style("left","0px"),u.merge(e.select("div.bar-label")).html(d.label).style("max-width",f.x.range()[1]-10+"px"),e.exit().transition().duration(s).style("opacity","0.01").style("top",f.y.range()[1]-l+"px").remove(),m.div.style("height",f.y.range()[1]+"px"),a},a.width=function(t){return arguments.length?(u=t,a):u},a.barHeight=function(t){return arguments.length?(l=t,a):l},a.barPadding=function(t){return arguments.length?(o=t,a):o},a.key=function(t){return arguments.length?(d.key=t,a):d.key},a.value=function(t){return arguments.length?(d.value=t,a):d.value},a.label=function(t){return arguments.length?(d.label=t,a):d.label},a.widthExtent=function(t){return arguments.length?(h.width=t,h.width.getValue(function(t,e){return d.value(t,e)}),a):h.width},a.dispatch=function(t){return arguments.length?a:g},a.duration=function(t){return arguments.length?(s=t,a):s},a},t.controllerRealtimeBins=/*
