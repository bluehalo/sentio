...
!function(t,e){"object"==typeof exports&&"undefined"!=typeof module?e(exports,require("d3-dispatch"),require("d3-interpolate"),require("d3-scale"),require("d3-shape"),require("d3-axis"),require("d3-brush"),require("d3-voronoi"),require("d3-selection"),require("d3-line")):"function"==typeof define&&define.amd?define(["exports","d3-dispatch","d3-interpolate","d3-scale","d3-shape","d3-axis","d3-brush","d3-voronoi","d3-selection","d3-line"],e):e(t.sentio={},t.d3,t.d3,t.d3,t.d3,t.d3,t.d3,t.d3,t.d3,t.d3)}(this,function(t,e,n,r,i,a,u,l,o,c){"use strict";function s(t){/**
	 * Private Functions
	 */
...
return e[0]>e[1]&&(e[1]=e[0]),e},u(t),u}function d(t){function e(t){i=t}function n(t){a=t}/*
	 * Constructor/initialization method
	 */
function r(t){null!=t&&(null!=t.extent&&e(t.extent),null!=t.series&&n(t.series))}var i=s(),a=[];/**
	 * Public API
	 */
/*
...
p=t}function r(){return p&&null!=g}/**
...
v=!0,n?g.move(t,void 0):g.move(t,e.map(f))}function d(t){if(null==t)throw new Error("Must provide a brush and a scale");if(null==t.brush)throw new Error("Must provide a brush");if((g=t.brush).on("brush",l("brush")).on("start",l("start")).on("end",l("end")),null==t.scale)throw new Error("Must provide a scale");f=t.scale,null!=t.enabled&&n(t.enabled)}/**
	 * Private variables
	 */
// The brush object
var g,f,h=e.dispatch("brush","start","end"),m=void 0,p=!1,v=!1;/**
	 * Public API
	 */
// Get/Set enabled state
// Initialize the model
return d.scale=function(t){return arguments.length?(f=t,d):f},d.dispatch=function(){return h},d.brush=function(){return g},d.enabled=function(t){return arguments.length?(n(t),d):r()},d.getSelection=function(t){return c(t)},d.setSelection=function(t,e){return s(t,e)},d(t),d}/**
 *
 *  data: []
 *  series: [ {label, x, y} ]
 *
...
var e=M.x.getExtent(P);m(null!=e&&Array.isArray(e)&&2==e.length?[Math.max(e[0],t[0]),Math.min(e[1],t[1])]:void 0)}X.g.brush.style("display",L.enabled()?"unset":"none").call(L.brush())}function v(){null!=C.x&&X.g.xAxis.call(C.x),null!=C.xGrid&&A.xGrid&&X.g.xAxisGrid.call(C.xGrid),null!=C.y&&X.g.yAxis.call(C.y),null!=C.yGrid&&A.yGrid&&X.g.yAxisGrid.call(C.yGrid)}function x(){
// Join
...
X.g.voronoi.selectAll("path").remove(),A.pointEvents){
// check range against width
var l=G.x.domain(),s=t(O,P,E.valueX).filter(function(t){
// Filter out points that are outside of the extent
return l[0]<=t.x&&t.x<=l[1]});
// Filter out paths that are null
s=_.polygons(s).filter(function(t){return null!=t}),
// Draw the circle markers
X.g.voronoi.selectAll("path").data(s).enter().append("path").attr("d",function(t){return null!=t?"M"+t.join("L")+"Z":null}).on("mouseover",o).on("mouseout",c).on("click",f)}e.exit().remove()}function y(){
// Join
var t=X.g.markers.selectAll(".marker").data(q,E.markerValueX),e=t.enter().append("g").attr("class","marker").on("mouseover",function(t,e){I.call("markerMouseover",this,t,e)}).on("mouseout",function(t,e){I.call("markerMouseout",this,t,e)}).on("click",function(t,e){I.call("markerClick",this,t,e)}),n=e.append("line"),r=e.append("text");n.attr("y1",function(t){return G.y.range()[1]}).attr("y2",function(t){return G.y.range()[0]}),r.attr("dy","0em").attr("y",-3).attr("text-anchor","middle").text(E.markerValueLabel);
// Enter + Update
var i=t.select("line"),a=t.select("text");n.merge(i).attr("x1",function(t,e){return G.x(E.markerValueX(t,e))}).attr("x2",function(t,e){return G.x(E.markerValueX(t))}),r.merge(a).attr("x",function(t,e){return G.x(E.markerValueX(t))}),
// Exit
t.exit().remove()}
// Chart create/init method
function b(){}var k="timeline_line_"+Date.now(),w={top:10,right:10,bottom:20,left:40},z=100,V=600,A={xGrid:!1,yGrid:!1,pointEvents:"highlight-values"},E={valueX:function(t){return t[0]},markerValueX:function(t){return t[0]},markerLabel:function(t){return t[1]},pointRadius:function(){return 2}},S=Date.now(),M={x:s({defaultValue:[S-3e5,S],getValue:function(t,e){return E.valueX(t,e)}}),y:s()},B=d(),G={x:r.scaleTime(),y:r.scaleLinear()},C={x:a.axisBottom().scale(G.x),y:a.axisLeft().ticks(3).scale(G.y),xGrid:a.axisBottom().tickFormat("").tickSizeOuter(0).scale(G.x),yGrid:a.axisLeft().tickFormat("").tickSizeOuter(0).ticks(3).scale(G.y)},T=i.line().x(function(t,e){return G.x(E.valueX(t,e))}),N=i.area().x(function(t,e){return G.x(E.valueX(t,e))}),_=l.voronoi().x(function(t,e){return G.x(t.x,e)}).y(function(t,e){return G.y(t.y,e)}),L=g({brush:u.brushX(),scale:G.x});L.dispatch().on("end",function(){I.call("brushEnd",this,h())}).on("start",function(){I.call("brushStart",this,h())}).on("brush",function(){I.call("brush",this,h())});
// The dispatch object and all events
var I=e.dispatch("brush","brushStart","brushEnd","markerClick","markerMouseover","markerMouseout","pointMouseover","pointMouseout","pointClick"),X={svg:void 0,g:{container:void 0,plots:void 0,points:void 0,voronoi:void 0,xAxis:void 0,yAxis:void 0,xAxisGrid:void 0,yAxisGrid:void 0,markers:void 0,brush:void 0},plotClipPath:void 0,markerClipPath:void 0},P=[],O=[],q=[];/**
...
// Resize the brush
return X.svg.attr("width",V).attr("height",z),X.g.container.attr("transform","translate("+w.left+","+w.top+")"),G.x.range([0,Math.max(0,V-w.left-w.right)]),G.y.range([Math.max(0,z-w.top-w.bottom),0]),X.plotClipPath.attr("transform","translate(0, -1)").attr("width",Math.max(0,G.x.range()[1])+2).attr("height",Math.max(0,G.y.range()[0])+2),X.markerClipPath.attr("transform","translate(0, -"+w.top+")").attr("width",Math.max(0,V-w.left-w.right)).attr("height",Math.max(0,z-w.bottom)),_.extent([[0,0],[V-w.left-w.right,z-w.top-w.bottom]]),X.g.xAxis.attr("transform","translate(0,"+G.y.range()[0]+")"),X.g.xAxisGrid.attr("transform","translate(0,"+G.y.range()[0]+")"),A.xGrid?C.xGrid.tickSizeInner(-(z-w.top-w.bottom)):C.xGrid.tickSizeInner(0),A.yGrid?C.yGrid.tickSizeInner(-(V-w.left-w.right)):C.yGrid.tickSizeInner(0),X.g.brush.selectAll("rect").attr("y",-1).attr("x",0).attr("width",G.x.range()[1]).attr("height",G.y.range()[0]+2),L.brush().extent([[0,0],[G.x.range()[1],G.y.range()[0]+2]]),p(t),b},b.redraw=function(){
// Need to grab the brush extent before we change anything
var t=h();
// Update the x domain (to the latest time window)
// Update the y domain (based on configuration and data)
// Update the plot elements
return G.x.domain(M.x.getExtent(P)),G.y.domain(B.extent(M.y).series(O).getExtent(P)),v(),x(),y(),p(t),b},b.width=function(t){return arguments.length?(V=t,b):V},b.height=function(t){return arguments.length?(z=t,b):z},b.margin=function(t){return arguments.length?(w=t,b):w},b.showXGrid=function(t){return arguments.length?(A.xGrid=t,b):A.xGrid},b.showYGrid=function(t){return arguments.length?(A.yGrid=t,b):A.yGrid},b.showGrid=function(t){return A.xGrid=A.yGrid=t,b},b.pointEvents=function(t){return arguments.length?(A.pointEvents=t,b):A.pointEvents},b.curve=function(t){return arguments.length?(T.curve(t),N.curve(t),b):T.curve()},b.xAxis=function(t){return arguments.length?(C.x=t,b):C.x},b.xGridAxis=function(t){return arguments.length?(C.xGrid=t,b):C.xGrid},b.yAxis=function(t){return arguments.length?(C.y=t,b):C.y},b.yGridAxis=function(t){return arguments.length?(C.yGrid=t,b):C.yGrid},b.xScale=function(t){return arguments.length?(G.x=t,null!=C.x&&C.x.scale(t),null!=C.xGrid&&C.xGrid.scale(t),null!=L&&L.scale(t),b):G.x},b.yScale=function(t){return arguments.length?(G.y=t,null!=C.y&&C.y.scale(t),null!=C.yGrid&&C.yGrid.scale(t),b):G.y},b.xValue=function(t){return arguments.length?(E.valueX=t,b):E.valueX},b.yExtent=function(t){return arguments.length?(M.y=t,b):M.y},b.xExtent=function(t){return arguments.length?(M.x=t,b):M.x},b.markerXValue=function(t){return arguments.length?(E.markerValueX=t,b):E.markerValueX},b.markerLabel=function(t){return arguments.length?(E.markerValueLabel=t,b):E.markerValueLabel},b.dispatch=function(t){return arguments.length?b:I},b.brush=function(t){return arguments.length?(L.enabled(t),b):L.enabled()},b.setBrush=function(t){return m(t),b},b.getBrush=function(){return h()},b}/**
...
t.exit().remove()}
// Chart height/width
var o,c=400,s=400,d={top:2,bottom:2,right:2,left:2},g=.7,f=500,h={enabled:!0,markSize:16,markMargin:8,labelOffset:2,position:"center",// only option right now
...
return o=Math.min(n,e)/2,y.svg.attr("width",c).attr("height",s),y.gChart.attr("transform","translate("+(d.left+o)+","+(d.top+o)+")"),x.arc.innerRadius(o*g).outerRadius(o),y.gLegend.attr("transform",u()),t},t.redraw=function(){return a(),h.enabled&&l(),t},t.width=function(e){return arguments.length?(c=e,t):c},t.height=function(e){return arguments.length?(s=e,t):s},t.innerRadiusRatio=function(e){return arguments.length?(g=e,t):g},t.duration=function(e){return arguments.length?(f=e,t):f},t.key=function(e){return arguments.length?(p.key=e,t):p.key},t.value=function(e){return arguments.length?(p.value=e,t):p.value},t.label=function(e){return arguments.length?(p.label=e,t):p.label},t.colorScale=function(e){return arguments.length?(v.color=e,t):v.color},t.dispatch=function(){return m},t.legend=function(e){return arguments.length?(h=e,t):h},t},t.chartMatrix=function(){function t(t,e){var n=b.g.chart.selectAll(".row text");if(null!=t){
// Set the highlight on the row
var r=t.key;n.classed("active",function(t){return t.key==r})}else
// Now update the style
n.classed("active",!1)}function n(e,n){t(e,n),z.call("rowMouseover",this,e,n)}function i(e,n){t(),z.call("rowMouseout",this,e,n)}function u(t,e){z.call("rowClick",this,t,e)}function l(t,e){z.call("cellMouseover",this,t,e)}function o(t,e){z.call("cellMouseout",this,t,e)}function c(t,e){z.call("cellClick",this,t,e)}/**
	 * Style stuff
	 */
// Cell dimensions
var g=16,f=1,h={top:20,right:2,bottom:2,left:64},m=500,p={key:function(t){return t.key},value:function(t){return t.value}},v={x:s().getValue(function(t,e){return p.key(t,e)}),value:s().getValue(function(t,e){return p.value(t,e)}),multi:d()},x={x:r.scaleLinear(),y:r.scaleOrdinal(),color:r.scaleLinear().range(["#e7e7e7","#008500"])},y={x:a.axisTop().scale(x.x).tickSizeOuter(0).tickSizeInner(2)},b={div:void 0,svg:void 0,g:{chart:void 0,xAxis:void 0}},k=[],w=[],z=e.dispatch("cellMouseover","cellMouseout","cellClick","rowMouseover","rowMouseout","rowClick"),V=function(){};return V.init=function(t){
// Add the svg element
// Add the axis
// Add a group for the chart itself
return b.div=t.append("div").attr("class","sentio matrix"),b.svg=b.div.append("svg"),b.g.xAxis=b.svg.append("g").attr("class","x axis"),b.g.chart=b.svg.append("g").attr("class","chart"),V},V.redraw=function(){
// Determine the number of rows/boxes to render
var t=w.length,e=k.length,r=f+g,a=e*r+f,s=t*r+f;
// scale the svg to the right size
b.svg.attr("width",a+h.left+h.right).attr("height",s+h.top+h.bottom),
// Configure the scales
x.x.domain(v.x.getExtent(k)).range([0,a-f-r]),x.color.domain(v.multi.extent(v.value).series(w).getExtent(k)),
// Draw the x axis
b.g.xAxis.attr("transform","translate("+(h.left+f+g/2)+","+h.top+")"),b.g.xAxis.call(y.x);/**
		 * Chart Manipulation
		 */
/*
		 * Row Join
		 */
var d=b.g.chart.selectAll("g.row").data(w,function(t){return t.key}),z=d.enter().append("g");z.style("opacity","0.1").attr("class","row").attr("transform",function(t,e){return"translate("+h.left+","+(h.top+r*e)+")"}).on("mouseover",n).on("mouseout",i).on("click",u),
// Also must append the label of the row
z.append("text").attr("class","series label").style("text-anchor","end").attr("x",-6).attr("y",f+g/2).attr("dy",".32em"),
// Also must append a line
z.append("line").attr("class","series tick").attr("x1",-3).attr("x2",0).attr("y1",f+g/2).attr("y2",f+g/2);/*
		 * Row Enter + Update
		 */
// Transition rows to their new positions
var A=z.merge(d);A.transition().duration(m).style("opacity","1").attr("transform",function(t,e){return"translate("+h.left+","+(h.top+r*e)+")"}),
// Update the series labels in case they changed
A.select("text.series.label").text(function(t){return t.label}),/*
		 * Row Exit
		 */
d.exit().transition().duration(m).style("opacity","0.1").remove();/*
		 * Cell Join - Will be done on row enter + exit
		 */
var E=A.selectAll("rect.cell").data(function(t){return k.map(function(e,n){return{key:p.key(e,n),value:t.getValue(e,n)}})},p.key);/*
		 * Cell Remove
		 */
return E.enter().append("rect").attr("class","cell").style("opacity","0.1").style("fill",function(t,e){return x.color(t.value)}).attr("x",function(t,e){return x.x(t.key)+f}).attr("y",f).attr("height",g).attr("width",g).on("mouseover",l).on("mouseout",o).on("click",c).merge(E).transition().duration(m).style("opacity","1").attr("x",function(t,e){return x.x(t.key)+f}).style("fill",function(t,e){return x.color(t.value)}),E.exit().transition().duration(m).attr("width",0).style("opacity","0.1").remove(),V},V.data=function(t){return arguments.length?(k=null!=t?t:[],V):k},V.series=function(t){return arguments.length?(w=null!=t?t:[],V):w},V.cellSize=function(t){return arguments.length?(g=t,V):g},V.cellMargin=function(t){return arguments.length?(f=t,V):f},V.margin=function(t){return arguments.length?(h=t,V):h},V.duration=function(t){return arguments.length?(m=t,V):m},V.key=function(t){return arguments.length?(p.key=t,V):p.key},V.colorScale=function(t){return arguments.length?(x.color=t,V):x.color},V.xScale=function(t){return arguments.length?(x.xScale=t,y.x.scale(t),V):x.xScale},V.yScale=function(t){return arguments.length?(x.yScale=t,V):x.yScale},V.xExtent=function(t){return arguments.length?(v.x=t,v.x.getValue(function(e,n){return t(e,n)}),V):v.x},V.valueExtent=function(t){return arguments.length?(v.value=t,v.value.getValue(function(e,n){return t(e,n)}),V):v.value},V.dispatch=function(){return z},V},t.chartTimeline=f,t.chartAutoBrushTimeline=
// import { voronoi as d3_voronoi } from 'd3-voronoi';
function(){function t(t){var e=t;
...
p.call("brushChange",this,e)):
// Don't allow them to apply an invalid brush
x.setBrush(u),v.redraw()}/**
	 * Update the extent
	 */
function r(){var t=i(u);if(t.pan||t.zoom){
// Update the Extent and fire the event
var e=a(u,t);v.xExtent().overrideValue(e),p.call("extentChange",this,e)}}/**
	 ...
	 */
function i(t){var e={pan:!1,zoom:!1};if(null!=t){var n=v.xScale(),r=n.domain()[0],i=t[0],a=t[1],u=n.domain()[1],l=u-r,o=(a-i)/l,c=(i-r)/l<=s.edgeTrigger&&i>h[0],d=(u-a)/l<=s.edgeTrigger&&a<h[1];
...
e.zoom=o>=s.zoomOutTrigger||o<=s.zoomInTrigger,e.pan=c||d}return e}/**
	 ...
	 * @returns {[*,*]}
	 */
function a(t,e){var n=v.xScale().domain()[0],r=t[0],i=t[1],a=v.xScale().domain()[1]-n;
...
return a-=o-u,l=Math.max(l-a,h[0]),[l,o]}var u,l="autobrush_timeline_"+Date.now(),o=Date.now(),s={edgeTrigger:.01,zoomInTrigger:.05,zoomOutTrigger:.8,zoomTarget:.2},d=864e5,g=36e5,h=[o-31536e7,o],m=[o-15552e6,o],p=e.dispatch("extentChange","brushChange"),v=f(),x={element:{g:{container:void 0},axisClipPath:void 0},brush:v.brush,dispatch:v.dispatch,init:v.init,resize:v.resize,redraw:v.redraw,setBrush:v.setBrush,xAxis:v.xAxis};
...
return x.element.g.container=t,x.init(t),x.brush(!0),x.dispatch().on("brushEnd.internal",n),null==u&&(u=m,v.setBrush(u)),x.element.axisClipPath=t.select("svg defs").append("clipPath").attr("id","axis_"+l).append("rect"),x.element.g.container.select("div.sentio.timeline").select("g.axis .x").attr("clip-path","url(#axis_"+l+")"),v.resize(),v},v.redraw=function(){
...
// Call it to redraw
return t.selectAll("g.tick text").attr("y","3").attr("dy","-0.71em").attr("dx","0.35em").attr("text-anchor","start"),v.xAxis().tickSize(-v.height()+v.margin().top+v.margin().bottom),v.curve(c.curveNatural),null!=v.xAxis()&&t.call(v.xAxis()),v},v.resize=function(){
...
var e=0,n=6e4,r=!1,i=null,a=32,u=f();u.yExtent().filter(function(t){var e=u.xValue()(t),n=u.xExtent().getExtent();return e<n[1]&&e>n[0]});/*
	 * Redraw the graphic
	 */
var l=u.redraw;return u.redraw=function(){
// Update the x domain (to the latest time window)
var t=new Date;return u.xExtent().overrideValue([t-e-n,t-e]),l(),u},u.start=function(){if(!r)return r=!0,t(),u},u.stop=function(){return r=!1,null!=i&&window.clearTimeout(i),u},u.restart=function(){return u.stop(),u.start(),u},u.interval=function(t){return arguments.length?(n=t,u):n},u.delay=function(t){return arguments.length?(e=t,u):e},u.fps=function(t){return arguments.length?(a=t,r&&u.restart(),u):a},u},t.chartVerticalBars=function(){
// Chart create/init method
function t(t){}
// Layout properties
var n=100,i=24,a=2,u=500,l=e.dispatch("mouseover","mouseout","click"),o={mouseover:function(t,e){l.call("mouseover",this,t,e)},mouseout:function(t,e){l.call("mouseout",this,t,e)},click:function(t,e){l.call("click",this,t,e)},key:function(t){return t.key},value:function(t){return t.value},label:function(t){return t.key+" ("+t.value+")"}},c={x:r.scaleLinear(),y:r.scaleLinear()},d={width:s({defaultValue:[0,10],getValue:function(t,e){return o.value(t,e)}})},g={div:void 0},f=[];/*
	 * Initialize the chart (should only call this once). Performs all initial chart
	 * creation and setup
	 */
/*
...
return t.init=function(e){
// Create the DIV element
return g.div=e.append("div").attr("class","sentio bars-vertical"),t.resize(),t},t.data=function(e){return arguments.length?(f=null!=e?e:[],t):f},t.resize=function(){
// Set up the x scale (y is fixed)
return c.x.range([0,n]),t},t.redraw=function(){
// Update the x domain
c.x.domain(d.width.getExtent(f)),
// Update the y domain (based on configuration and data)
c.y.domain([0,f.length]),c.y.range([0,(i+a)*f.length]);
// Data Join
var e=g.div.selectAll("div.bar").data(f,o.key),n=e.enter().append("div").attr("class","bar").style("top",c.y.range()[1]-i+"px").style("height",i+"px").on("mouseover",o.mouseover).on("mouseout",o.mouseout).on("click",o.click).style("opacity","0.01"),r=n.append("div").attr("class","bar-label");
// Enter + Update
// Exit
// Update the size of the parent div
return n.merge(e).transition().duration(u).style("opacity","1").style("width",function(t,e){return c.x(o.value(t,e))+"px"}).style("top",function(t,e){return c.y(e)+"px"}).style("left","0px"),r.merge(e.select("div.bar-label")).html(o.label).style("max-width",c.x.range()[1]-10+"px"),e.exit().transition().duration(u).style("opacity","0.01").style("top",c.y.range()[1]-i+"px").remove(),g.div.style("height",c.y.range()[1]+"px"),t},t.width=function(e){return arguments.length?(n=e,t):n},t.barHeight=function(e){return arguments.length?(i=e,t):i},t.barPadding=function(e){return arguments.length?(a=e,t):a},t.key=function(e){return arguments.length?(o.key=e,t):o.key},t.value=function(e){return arguments.length?(o.value=e,t):o.value},t.label=function(e){return arguments.length?(o.label=e,t):o.label},t.widthExtent=function(e){return arguments.length?(d.width=e,d.width.getValue(function(t,e){return o.value(t,e)}),t):d.width},t.dispatch=function(e){return arguments.length?t:l},t.duration=function(e){return arguments.length?(u=e,t):u},t},t.controllerRealtimeBins=/*
...
l=!1}
// create/init method
function a(t){if(null==t||null==t.binCount||null==t.binSize)throw new Error("You must provide an initial binSize and binCount");o.binSize=Number(t.binSize),o.binCount=Number(t.binCount),null!=t.delay&&(o.delay=Number(t.delay)),(u=h({size:o.binSize,count:o.binCount+2,lwm:0})).lwm(e()),r()}/**
	 * Private variables
	 */
